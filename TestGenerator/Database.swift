...
class Database {
    ...
    init() {
        //기본 문제생성, 법인 아닌 사단 SO
        let test변호사시험민사법샘플 = Test(database: self, isPublished: false, category: "변호사시험", subject: "민사법", number: 1, numHelper: 2017)
        test변호사시험민사법샘플.description = "데이터 검사목적으로 Database 객체에서 생성한 변호사시험 민사법 시험문제들의 집합"
        
        let test공인중개사1차샘플2 = Test(database: self, isPublished: false, category: "공인중개사", subject: "1차", number: 25, numHelper: nil)
        ...
        //기본 문제생성, 계약 SD
        let question2 = Question(test : test변호사시험민사법샘플, number : 3, questionType: QuestionType.Select, questionOX : QuestionOX.Difference , content : "다음 설명들에 대하여 옳은 것과 옳지 않은 것을 표시할 경우, 다른 설명과 그 결과가 다른 하나는?", answer : 3)
        ...
        //기본 문제생성, 동시이행의 항변 FC
        let question4 = Question(test : test변호사시험민사법샘플, number : 5, questionType: QuestionType.Find, questionOX : QuestionOX.Correct , content : "태아에 관한 다음 설명 중 옳은 것(O)과 옳지 않은 것(X)을 올바르게 조합한 것은?", answer : 1)
        ...
        //기본 문제생성, 매도인의 담보책임 SX
        let question5 = Question(test : test변호사시험민사법샘플, number : 6, questionType: QuestionType.Select, questionOX : QuestionOX.Correct , content : "甲은 어느 날 乙로부터 책 한 권과 함께 \"이 책이 마음에 드시면 아래 계좌에 대금을 납부해주십시오\"라는 서면을 받았다. 甲은 그 책을 읽다가 흥미를 느껴서 밑줄까지 그어가며 읽었고, 다 읽은 후에는 丙에게 \"참 좋은 책이니 너도 한 번 읽어봐라\"라는 편지와 함께 그 책을 보내주었다. 이 경우 甲과 乙 사이의 법률관계를 설명하는 방법으로 가장 적당한 것은?", answer : 4)
