...
class DC변호사시험민사법 : DataConverter {
    ...
    convenience init() {
        self.init(testCategory: "변호사시험", testSubject: "민사법", answerFilename: "변호사시험 1~6회 민사법 정답.json", questionFilename: "변호사시험-1~6회-민사법.txt")
        ...
        sliceTestString(regexPattern: "=-=변호사시험-\\d회-민사법-선택형=-=", string: wholeTestString)
